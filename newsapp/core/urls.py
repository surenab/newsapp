...
from .views import Home, CreateNews, about, MyNews, MyNewsDetail, MyNewsUpdate, MyNewsDelete, profile, search_result, search_suggestions, single_post, Contact, Filter, category, CreateNewsComment, NewsDetails, update_profile, change_password
